...
export default async function Home() {
  ...
  const previewCatalog = buildPreviewCatalog(await listVisibleProducts(content.siteId));
  const previewShowcaseProduct = previewCatalog[0];
  const previewShowcaseVariant = previewShowcaseProduct
    ? getDefaultVariant(previewShowcaseProduct)
    : null;
        ...
        >
          <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            <div className="grid items-center gap-12 lg:grid-cols-2">
              ...
              {previewShowcaseVariant && previewShowcaseProduct ? (
                <HomePreviewShowcase
                  variant={previewShowcaseVariant}
                  productLabel={previewShowcaseProduct.label}
                  mockupTitle={previewSection.mockupTitle}
                  mockupSubtitle={previewSection.mockupSubtitle}
                />
              ) : (
                <HomePreviewShowcaseFallback
                  mockupTitle={previewSection.mockupTitle}
                  mockupSubtitle={previewSection.mockupSubtitle}
                />
              )}
